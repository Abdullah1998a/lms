...
١. إعادة استخدام نفس الشيفرة البرمجية عدة مرات دون تكرارها.<br>
٢. تنظيم البرنامج وتقسيمه إلى أجزاء منطقية أصغر.<br>
٣. تجنب التكرار وجعل البرنامج أكثر وضوحاً.
...
---
١. **التعريف**: نعرف التابع فوق الدالة الرئيسية \`()main\`.<br>
٢. **الاستدعاء**: نستدعي التابع داخل الدالة الرئيسية \`()main\`.
...
## أنواع التوابع:
---
١. **توابع جاهزة**: موجودة ضمن مكتبات اللغة (مثل \`sqrt\` في الرياضيات).<br>
٢. **توابع معرفة من المستخدم**: نقوم بتعريفها بأنفسنا.
...
> ### نصائح
>١. **افهم الفرق بين التابع والبرنامج الرئيسي**: التابع هو جزء صغير نستدعيه عند الحاجة.<br>
>٢. **تخيل التابع كآلة حاسبة**: تعطيها مدخلات (وسطاء) وتعطيك مخرجات (القيمة المعادة).<br>
>٣. **استخدم أسماء واضحة**: اختر أسماء معبرة للتوابع تصف ما تقوم به.
>٤. **انتبه للفرق بين التمرير بالقيمة والتمرير بالمرجع**: 
>   - التمرير بالقيمة: تنشئ نسخة مؤقتة من المتغيرات.
>   - التمرير بالمرجع: تعمل على المتغيرات الأصلية مباشرة.
>
>٥. **لا تنسَ تحديد نوع القيمة المعادة**: \`int\`, \`float\`, \`void\`, إلخ...<br>
>٦. **تجنب تكرار الشيفرة**: إذا كنت تستخدم نفس الشيفرة أكثر من مرة، حولها إلى تابع.
`
  },
  {
    id: 2,
    title: "المصفوفات",
    content: `### ما هي المصفوفات`
  }
